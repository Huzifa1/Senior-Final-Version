                            ...
                            <form method="post" action=<?php  echo 'code1.php?id='.$id; ?> class="form-card" onsubmit="return Validate()">
                                ...
                                <div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3" style="margin:0px 5px 5px 0px">Job<span class="text-danger"> *</span></label>
                                    <select class="form-select" id="email" name="job" aria-label="Default select example" style="height:45px;">
										...
										<option value="Chef" <?=$selectrow['staff_job']=='Chef'?'selected="selected"':'';?> >Chef</option>
                                        <option value="Social Expert" <?=$selectrow['staff_job']=='Social Expert'?'selected="selected"':'';?> >Social Expert</option>
                                        <option value="Craftsman" <?=$selectrow['staff_job']=='Craftsman'?'selected="selected"':'';?> >Craftsman</option>
                                        <option value="Technician" <?=$selectrow['staff_job']=='Technician'?'selected="selected"':'';?> >Technician</option>
                                        <option value="IT" <?=$selectrow['staff_job']=='IT'?'selected="selected"':'';?> >IT</option>
                                    </select> 
                                </div>  
